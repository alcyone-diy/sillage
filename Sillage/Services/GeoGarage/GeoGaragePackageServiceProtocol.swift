...
protocol GeoGaragePackageServiceProtocol: Sendable {
  ...
  ///   - accessToken: Jeton OAuth2 de l'utilisateur connecté (`Authorization: Bearer`) : depuis la
  ///     voie B (11 sept. 2026) le générateur y lit le client_id et le customer_id.
  ...
  ///   - accessToken: Jeton OAuth2 de l'utilisateur connecté.
  func fetchStatus(
    packageID: UUID,
    accessToken: String
