...
public struct WaypointRecord: Codable, FetchableRecord, PersistableRecord, Sendable {
  ...
  public init(id: String, name: String, description: String? = nil, symbol: String? = nil, color_hex: String? = nil, displayed: Bool = true, latitude_deg: Double, longitude_deg: Double, timestamp: Date) {
    self.id = id
    self.name = name
...
extension WaypointRecord {
  ...
  public init(domainModel: Waypoint) {
    ...
    self.displayed = domainModel.displayed
